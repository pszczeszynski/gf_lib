...
public class SpeedOmeter {
    ...
    public static double ySlipDistanceFor1CMPS = 0.36 * scalePrediction;//0.3999
    public static double xSlipDistanceFor1CMPS = 0.3 * scalePrediction;//0.117;
    //radians the robot slips when going 1 radian per second
    public static double turnSlipAmountFor1RPS = 0.12 * scalePrediction;//0.113;
