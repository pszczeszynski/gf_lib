package com.glutenfree.gf_lib.Debugging;
...
public class TimeProfiler {
    ...
    public void markStart(){
        if(System.currentTimeMillis()-sampleStartTime > millisPerClear){
    ...
    public void markEnd(){
        totalUpdates++;
        double elapsedTime = (System.currentTimeMillis()-updateStartTime)/1000.0;
